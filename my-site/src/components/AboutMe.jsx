...
<div className= "aboutMe-Container">
    ...
    <h2> With a history in education and a lifetime studying music, I am a passionate and dedicated lifetime learner who believes in using the creative mind to find solutions and solve any problem that comes my way. 
